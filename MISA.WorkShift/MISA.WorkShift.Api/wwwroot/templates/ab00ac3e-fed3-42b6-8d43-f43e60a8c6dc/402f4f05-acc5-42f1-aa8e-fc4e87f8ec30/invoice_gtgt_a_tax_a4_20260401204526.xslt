					...
					<div class="inner-content">
							...
							<tr>
								<td width="75%" style="vertical-align: top;">
									...
									<div style="margin-top: 4px;">
										Mã số thuế: <xsl:value-of select="/HDon/DLHDon/TTChung/NBan/MST"/>
									</div>
									<div style="margin-top: 2px;">
										Địa chỉ: <xsl:value-of select="/HDon/DLHDon/TTChung/NBan/DChi"/>
									</div>
									<div style="margin-top: 2px;">
										Điện thoại: <xsl:value-of select="/HDon/DLHDon/TTChung/NBan/SDThoai"/>
									</div>
								</td>
						...
						<div class="text-center">
							...
							<div class="text-right" style="margin-top: -35px;">
								<div>
									Ký hiệu: <span class="bold">
										<xsl:value-of select="/HDon/DLHDon/TTChung/KHHDon"/>
									</span>
								</div>
								<div>
									Số: <span class="bold" style="font-size: 16px;">
